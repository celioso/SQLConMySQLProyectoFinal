...
"Del Valle", "Ciudad de Mexico", "EM", "22002012", "1995-01-13",
26,  "M", 110000, 220000, 1 */
...
/* Cambier el nombre de una de una columna*/
ALTER TABLE `empresa`.`clientes` 
CHANGE COLUMN `DIRRECCION` `DIRECCION` VARCHAR(150) NULL DEFAULT NULL ;
